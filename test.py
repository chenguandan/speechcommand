...
def main(_):
    ...
    if FLAGS.use_extra==0:
        if feat_type is None:
            ...
            with open('out/{}_{}.pkl'.format(FLAGS.model_architecture, feat_type), 'wb') as fout:
                pickle.dump(test_probs, fout)
    else:
        if feat_type is None:
            with open('out/{}_{}.pkl'.format(FLAGS.model_architecture, FLAGS.use_extra), 'wb') as fout:
                pickle.dump(test_probs, fout)
        else:
            with open('out/{}_{}_{}.pkl'.format(FLAGS.model_architecture, feat_type, FLAGS.use_extra), 'wb') as fout:
                pickle.dump(test_probs, fout)
    with open('res_{}.csv'.format(FLAGS.model_architecture), 'w') as fout:
...
class ModelConfigureResnet(object):
    def __init__(self):
        ...
        if feat_type == 'normmfcc':
            self.start_checkpoint = 'model_resnetnormmfcc/resnet.ckpt-15000'
        elif feat_type == 'dmfcc':
            self.start_checkpoint = 'model_resnetdmfcc/resnet.ckpt-15000'
        else:
            self.start_checkpoint = 'model_resnet/resnet.ckpt-15000'
...
class ModelConfigureResnet101(object):
    def __init__(self):
        ...
        self.learning_rate = '0.001,0.0003,0.0001'
        self.batch_size = 32
        self.start_checkpoint = './model_resnet101{}/resnet101.ckpt-22000'.format(suffix)
...
class ModelConfigureResnetblstm(object):
    def __init__(self):
        ...
        self.learning_rate = '0.001,0.0003,0.0001'
        self.batch_size = 64
        self.start_checkpoint = 'model_resnetblstm{}/resnetblstm.ckpt-11000'.format(suffix)
...
class ModelConfigureXception(object):
    def __init__(self):
        ...
        self.learning_rate = '0.001,0.0003,0.0001'
        self.batch_size = 32
        self.start_checkpoint = 'model_xception{}/xception.ckpt-22000'.format(suffix)
...
class ModelConfigureCNNBLSTM(object):
    def __init__(self):
        ...
        if feat_type == 'normmfcc':
            self.start_checkpoint = 'model_cnnblstmnormmfcc/cnnblstm.ckpt-15000'
        elif feat_type == 'dmfcc':
            self.start_checkpoint = 'model_cnnblstmdmfcc/cnnblstm.ckpt-15000'
        else:
            self.start_checkpoint = './model_cnnblstm/cnnblstm.ckpt-15000'
...
class ModelConfigureCNNBLSTM2(object):
    ...
    def __init__(self):
        ...
        self.start_checkpoint = './model_cnnblstm2{}/cnnblstm2.ckpt-7000'.format(suffix)
...
class ModelConfigureCNNBLSTM6(object):
    ...
    def __init__(self):
        ...
        self.lr_steps = '4000,3000'  # 15000,10000,3000
        self.learning_rate = '0.001,0.0001'
        self.start_checkpoint = './model_cnnblstm6{}/cnnblstm6.ckpt-6000'.format(suffix)
...
class ModelConfigureCNNBLSTMBND(object):
    ...
    def __init__(self):
        ...
        self.batch_size = 64
        self.start_checkpoint = 'model_cnnblstmbnd{}/cnnblstmbnd.ckpt-11000'.format(suffix)
...
class ModelConfigureLace(object):
    ...
    def __init__(self):
        ...
        if feat_type == 'normmfcc':
            self.start_checkpoint = './model_lacenormmfcc/lace.ckpt-12000'
        elif feat_type == 'dmfcc':
            self.start_checkpoint = './model_lacedmfcc/lace.ckpt-12000'
        else:
            self.start_checkpoint = './model_lace/lace.ckpt-12000'
...
class ModelConfigureLace2(object):
    ...
    def __init__(self):
        ...
        if feat_type == 'normmfcc':
            self.start_checkpoint = './model_lace2normmfcc/lace2.ckpt-11000'
        elif feat_type == 'dmfcc':
            self.start_checkpoint = './model_lace2dmfcc/lace2.ckpt-12000'
        else:
            self.start_checkpoint = './model_lace2/lace2.ckpt-12000'
...
class ModelConfigureSEResnet(object):
    ...
    def __init__(self):
        ...
        self.batch_size = 16
        if feat_type == 'normmfcc':
            self.start_checkpoint = './model_se_resnetnormmfcc/se_resnet.ckpt-19000'
        elif feat_type == 'dmfcc':
            self.start_checkpoint = './model_se_resnetdmfcc/se_resnet.ckpt-19000'
        else:
            self.start_checkpoint = './model_se_resnet/se_resnet.ckpt-19000'
        # self.start_checkpoint = 'model_se_resnet/se_resnet.ckpt-19000'
...
if __name__ == '__main__':
    ...
    conf = ModelConfigureCNNBLSTMBND()
    confs.append(conf)
    conf = ModelConfigureCNNBLSTM()#dmfcc
    confs.append(conf)
    conf = ModelConfigureCNNBLSTM2()
    confs.append(conf)
    # conf = ModelConfigureCNNBLSTM6()
    # confs.append(conf)
    # conf = ModelConfigureLace()#dmfcc
    # confs.append(conf)
    # conf = ModelConfigureLace2()#dmfcc
    # confs.append(conf)
