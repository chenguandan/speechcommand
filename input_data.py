...
class AudioProcessor(object):
    ...
    def get_data(self, how_many, offset, model_settings, background_frequency,
                 background_volume_range, time_shift, mode, sess, feat_type=None, label_smooth = False):
        ...
        for i in xrange(offset, offset + sample_count):
            ...
            #TODO 调试不同的label smooth
            prob_eps = min(np.abs(time_shift_amount / 10000.0), 0.01)
            if label_smooth:
