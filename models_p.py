...
from resnet import create_resnet_model_p, create_resnet_model101_p, create_resnetblstm_model_p
from xception import create_xception_model_p
from SE_ResNeXt import create_senet_resnet_p
...
def create_model(fingerprint_input, person_embed, word_embed, model_settings, model_architecture,
    ...
    if model_architecture == 'resnet':
        return create_resnet_model_p(fingerprint_input,person_embed, word_embed, model_settings,
                                   is_training)
    elif model_architecture == 'resnet101':
        return create_resnet_model101_p(fingerprint_input,person_embed, word_embed, model_settings,
                                   is_training)
    elif model_architecture == 'resnetblstm':
        return create_resnetblstm_model_p(fingerprint_input, person_embed, word_embed,model_settings,
                                   is_training)
    elif model_architecture == 'xception':
        return create_xception_model_p(fingerprint_input, person_embed, word_embed,model_settings,
                                   is_training)
    elif model_architecture == 'cnnblstm':
        return create_cnnblstm_model_p(fingerprint_input,person_embed, word_embed,model_settings,
                                     is_training)
    elif model_architecture == 'cnnblstm2':
        return create_cnnblstm_model_v2_p(fingerprint_input, person_embed, word_embed,model_settings,
                                     is_training)
    elif model_architecture == 'cnnblstm6':
        return create_cnnblstm_model_v6_p(fingerprint_input, person_embed, word_embed, model_settings,
                                        is_training)
    elif model_architecture == 'cnnblstmbnd':
        return create_cnnblstm_bnd_model_v6_p(fingerprint_input, person_embed, word_embed,model_settings,
                                        is_training)
    elif model_architecture == 'lace':
        return create_lace_p(fingerprint_input, person_embed, word_embed,model_settings,
                                        is_training)
    elif model_architecture == 'lace2':
        return create_lacev2_p(fingerprint_input, person_embed, word_embed, model_settings,
                                        is_training)
    elif model_architecture == 'se_resnet':
        return create_senet_resnet_p(fingerprint_input, person_embed, word_embed, model_settings,
                            is_training)
...
def create_cnnblstm_model_p(fingerprint_input, person_embed, word_embed, model_settings,
                                  is_training):
    """
    Args:
      fingerprint_input: TensorFlow node that will output audio feature vectors.
...
def create_cnnblstm_model_v2_p(fingerprint_input, person_embed, word_embed,model_settings,
                                  is_training):
    """
    Args:
      fingerprint_input: TensorFlow node that will output audio feature vectors.
...
def create_cnnblstm_model_v6_p(fingerprint_input, person_embed, word_embed,model_settings,
                                  is_training):
    """
    Args:
      fingerprint_input: TensorFlow node that will output audio feature vectors.
...
def create_cnnblstm_bnd_model_v6_p(fingerprint_input,person_embed, word_embed, model_settings,
                                  is_training):
    """
    Args:
      fingerprint_input: TensorFlow node that will output audio feature vectors.
...
def create_lace_p(fingerprint_input, person_embed, word_embed,model_settings,
                                  is_training):
    """
    Args:
      fingerprint_input: TensorFlow node that will output audio feature vectors.
    ...
    final_fc_ = merge_ops(final_fc_, person_embed, word_embed, is_training)
...
def create_lacev2_p(fingerprint_input,person_embed, word_embed, model_settings,
                                  is_training):
    """
    Args:
      fingerprint_input: TensorFlow node that will output audio feature vectors.
