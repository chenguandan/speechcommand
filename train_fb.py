...
def main(_):
    ...
    model_settings = models_fb.prepare_model_settings(
        len(input_datafb.prepare_words_list(FLAGS.wanted_words.split(','))),
        FLAGS.sample_rate, FLAGS.clip_duration_ms, FLAGS.window_size_ms,
        FLAGS.window_stride_ms, FLAGS.dct_coefficient_count)
    audio_processor = input_datafb.AudioProcessor(
        FLAGS.data_url, FLAGS.data_dir, FLAGS.silence_percentage,
        FLAGS.unknown_percentage,
        FLAGS.wanted_words.split(','), FLAGS.validation_percentage,
        FLAGS.testing_percentage, model_settings, label_smooth=label_smooth)
    ...
    for training_step in xrange(start_step, training_steps_max + 1):
        ...
        train_fingerprints, train_ground_truth = audio_processor.get_data(
            ...
            FLAGS.background_volume, time_shift_samples, 'training', sess, label_smooth=label_smooth)
...
class ModelConfigureResnetLS(object):
    def __init__(self):
        self.summaries_dir='./logs_resnetfbls'#retrain_logs
        self.lr_steps = '8000,4000,3000'  # 15000,10000,3000
        self.learning_rate = '0.001,0.0003,0.0001'
        self.batch_size = 64
        self.start_checkpoint = ''
        self.model_architecture='resnet'  # 'conv',
        self.train_dir ='./model_resnetfbls'
            # '/tmp/speech_commands_train',
            # cnn   './model_train'
            # resnet dropout 0.5 model_train2
            # resnet dropout 1.0 model_train_resnet
