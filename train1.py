...
# extra_datas = ['augmented_dataset/','augmented_dataset_verynoisy/']
extra_datas = ['augmented_dataset/',]
def main(_):
    ...
    model_settings = models.prepare_model_settings(
        len(input_data1.prepare_words_list(FLAGS.wanted_words.split(','))),
        FLAGS.sample_rate, FLAGS.clip_duration_ms, FLAGS.window_size_ms,
        FLAGS.window_stride_ms, FLAGS.dct_coefficient_count)
    audio_processor = input_data1.AudioProcessor(
        FLAGS.data_url, FLAGS.data_dir, FLAGS.silence_percentage,
        FLAGS.unknown_percentage,
        FLAGS.wanted_words.split(','), FLAGS.validation_percentage,
        FLAGS.testing_percentage, model_settings, extra_datas)
...
class ModelConfigureResnet(object):
    def __init__(self):
        self.summaries_dir='./logs_resnet'+'_'+str(len(extra_datas))#retrain_logs
        self.lr_steps = '8000,3000'  # 15000,10000,3000
        self.learning_rate = '0.001,0.0001'
        self.start_checkpoint = ''  # './model_train_resnet/resnet.ckpt-40000',#'./model_train2/resnet.ckpt-27600',
        self.model_architecture='resnet'  # 'conv',
        self.train_dir ='./model_resnet'+'_'+str(len(extra_datas))
...
class ModelConfigureCNNBLSTM(object):
    ...
    def __init__(self):
        self.summaries_dir='./logs_cnnblstm'+'_'+str(len(extra_datas))#retrain_logs
        ...
        self.train_dir ='./model_cnnblstm'+'_'+str(len(extra_datas))

class ModelConfigureCNNBLSTM2(object):
    #2层lstm，使用conv与lstm的拼接
    def __init__(self):
        self.summaries_dir='./logs_cnnblstm2'+'_'+str(len(extra_datas))#retrain_logs
        self.lr_steps = '8000,3000'  # 15000,10000,3000
        self.learning_rate = '0.001,0.0001'
        self.start_checkpoint = ''
        self.model_architecture='cnnblstm2'  # 'conv',
        self.train_dir ='./model_cnnblstm2'+'_'+str(len(extra_datas))

class ModelConfigureCNNBLSTM6(object):
    #6层的gru，使用conv与lstm的拼接
    def __init__(self):
        self.summaries_dir='./logs_cnnblstm6'+'_'+str(len(extra_datas))#retrain_logs
        self.lr_steps = '8000,3000'  # 15000,10000,3000
        self.learning_rate = '0.001,0.0001'
        self.start_checkpoint = ''
        self.model_architecture='cnnblstm6'  # 'conv',
        self.train_dir ='./model_cnnblstm6'+'_'+str(len(extra_datas))


class ModelConfigureCNNBLSTMBND(object):
    #6层的gru，使用conv与lstm的拼接
    def __init__(self):
        self.summaries_dir='./logs_cnnblstmbnd'+'_'+str(len(extra_datas))#retrain_logs
        ...
        self.train_dir ='./model_cnnblstmbnd'+'_'+str(len(extra_datas))

class ModelConfigureLace(object):
    #6层的gru，使用conv与lstm的拼接
    def __init__(self):
        self.summaries_dir='./logs_lace'+'_'+str(len(extra_datas))#retrain_logs
        self.lr_steps = '8000,3000'  # 15000,10000,3000
        self.learning_rate = '0.001,0.0001'
        self.start_checkpoint = ''
        self.model_architecture='lace'  # 'conv',
        self.train_dir ='./model_lace'+'_'+str(len(extra_datas))


class ModelConfigureLace2(object):
    #6层的gru，使用conv与lstm的拼接
    def __init__(self):
        self.summaries_dir='./logs_lace2'+'_'+str(len(extra_datas))#retrain_logs
        self.lr_steps = '4000,4000,3000'  # 15000,10000,3000
        self.learning_rate = '0.001,0.0005,0.0001'
        self.start_checkpoint = ''
        self.model_architecture='lace2'  # 'conv',
        self.train_dir ='./model_lace2'+'_'+str(len(extra_datas))
