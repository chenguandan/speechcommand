...
class ModelConfigureResnet101(object):
    def __init__(self):
        ...
        self.learning_rate = '0.001,0.0003,0.0001'
        self.batch_size = 32
        self.start_checkpoint = './model_resnet101/resnet101.ckpt-22000'
...
class ModelConfigureResnetblstm(object):
    ...
    def __init__(self):
        ...
        self.lr_steps = '8000,4000,3000'  # 15000,10000,3000
        self.learning_rate = '0.001,0.0003,0.0001'
        self.start_checkpoint = 'model_resnetblstmp/resnetblstmp.ckpt-15000'
...
class ModelConfigureCNNBLSTM2(object):
    ...
    def __init__(self):
        ...
        self.start_checkpoint = './model_cnnblstm2/cnnblstm2.ckpt-7000'
...
class ModelConfigureCNNBLSTM6(object):
    ...
    def __init__(self):
        ...
        self.lr_steps = '4000,3000'  # 15000,10000,3000
        self.learning_rate = '0.001,0.0001'
        self.start_checkpoint = './model_cnnblstm6/cnnblstm6.ckpt-7000'#cnnblstm6.ckpt-7000
...
class ModelConfigureCNNBLSTMBND(object):
    ...
    def __init__(self):
        ...
        self.batch_size = 64
        self.start_checkpoint = 'model_cnnblstmbnd/cnnblstmbnd.ckpt-11000'
